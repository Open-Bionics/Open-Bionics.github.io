...
static const uint8_t SS	  = (8ul);				// CS_SD	
...
* USB
*/
#define PIN_USB_HOST_ENABLE (8ul)				// set to CS_SD, as cannot be undefined
#define PIN_USB_DM          (8ul)				// set to CS_SD, as cannot be undefined
#define PIN_USB_DP          (8ul)				// set to CS_SD, as cannot be undefined
