...
const PinDescription g_APinDescription[]=
{
	...
	{ PORTA,  4, PIO_EXTINT, (PIN_ATTR_DIGITAL | PIN_ATTR_EXTINT), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4 },				// D3 - PA04, EIC/EXTINT[4]
	...
	{ PORTA, 19, PIO_TIMER_ALT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM | PIN_ATTR_TIMER_ALT), No_ADC_Channel, PWM0_CH3, TCC0_CH3, EXTERNAL_INT_NONE },	// D14 - TCC0/W3[1]
	{ PORTA, 20, PIO_TIMER_ALT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM | PIN_ATTR_TIMER_ALT), No_ADC_Channel, PWM0_CH6, TCC0_CH6, EXTERNAL_INT_NONE },	// D15 - TCC0/WO[6]
	...
	// 28 - 29, UART (SWD pads)																											
	{ PORTA, 31, PIO_SERCOM_ALT, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },								// RX - SWDIO - SERCOM1/PAD[3]
	{ PORTA, 30, PIO_SERCOM_ALT, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },								// TX - SWCLK - SERCOM1/PAD[2] 

	// 30 - 31, UART (Wrist connector, instead of I2C)
	{ PORTA, 23, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },							// RX - SCL - SERCOM5/PAD[1]
	{ PORTA, 22, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },							// TX - SDA - SERCOM5/PAD[0]
...
Uart Serial(&sercom1, PIN_SERIAL_RX, PIN_SERIAL_TX, PAD_SERIAL_RX, PAD_SERIAL_TX);									// Serial on programming pads
Uart SerialWrist(&sercom5, PIN_SERIAL_WRIST_RX, PIN_SERIAL_WRIST_TX, PAD_SERIAL_WRIST_RX, PAD_SERIAL_WRIST_TX);		// Serial on wrist connector (replaces I2C)
